...
while true; do
    show_menu
    read -p "Choisissez une option (0-17) ou 'q' pour quitter: " choice
    ...
    case $choice in
        ...
        8)
            ...
            ;;
        9)
            echo -e "\033[96m✅ Validation des profils...\033[0m"
            echo -e "\033[90mCommande: ./validate-profiles.sh\033[0m"
